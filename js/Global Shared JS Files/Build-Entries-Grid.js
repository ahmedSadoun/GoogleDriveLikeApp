  ...
  for (; entityIndex < entities.length; entityIndex++) {
    ...
    if (element.isFolder) {
      entitiesColumnString =
        entitiesColumnString +
        `
           <div class="col mt-2 d-flex  overflow-x-hidden  hover-effect " style="max-width: 25%;">
           
            <input type="checkbox"   entry-identifier=${element.id} id="todoCheckbox" style="width:20px;height:20px;">
            
              <button
                onclick="onFolderClick(this)"
                entry-identifier=${element.id}
                type="button"
                class="btn border-0"
              ...
              >
                ...
                <div class="d-flex">
                  ...
                  <div class=" align-content-center"  style="width: 100%;">${element.name}</div>
